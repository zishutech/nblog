...
NOTEBOOK_URL = 'http://52.74.107.196:8000'
AWS_STORAGE_BUCKET_NAME = 'notebookstore'
...
DIRECTORY = getattr(settings, "FILEBROWSER_DIRECTORY", 'extra/')

# The URL/PATH to your filebrowser media-files.
URL_FILEBROWSER_MEDIA = getattr(settings, "FILEBROWSER_URL_FILEBROWSER_MEDIA", "%snotebrowser/" % settings.STATIC_URL)
PATH_FILEBROWSER_MEDIA = getattr(settings, "FILEBROWSER_PATH_FILEBROWSER_MEDIA", os.path.join(settings.MEDIA_ROOT, 'notebrowser/'))
