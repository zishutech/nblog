...
from notebook.functions import url_to_path, get_directory
    ...
    def render(self, name, value, attrs=None):
        ...
        if value != "":
            try:
                ...
                pass
        return render_to_string("notebrowser/custom_field.html", dict(locals(), MEDIA_URL=MEDIA_URL))
...
try:
    ...
    add_introspection_rules([], ["^notebook\.fields\.FileBrowseField"])
except ImportError:
    pass
